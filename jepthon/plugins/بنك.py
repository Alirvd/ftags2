...
- مثال: .انشاء حساب الرافدين او المجره الاسلامي
1- .استثمار (مبلغ) 
- مثال : استثمار 18276
2- .حظ (المبلغ)
- مثال : حظ 17267
...
async def bankar(message):
    ...
    if input == "المجره الاسلامي":
        bankn = "مصرف المجره الاسلامي"
    elif input == "الرافدين":
    	bankn = "مصرف الرافدين"
    elif input != "الرافدين" or "المجره الاسلامي":
