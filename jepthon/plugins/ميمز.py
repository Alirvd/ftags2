...
async def jepvois(vois):
  ...
  url = f"https://t.me/uwrwe/{rl}"
  await vois.client.send_file(vois.chat_id,url,caption="᯽︙ BY : @uwrwe 🎀",parse_mode="html")
  await vois.delete()
...
async def jepvois(vois):
  rl = random.randint(2,101)
  url = f"https://t.me/uwrwe/{rl}"
  await vois.client.send_file(vois.chat_id,url,caption="᯽︙ BY : @uwrwe 🤲🏻☪️",parse_mode="html")
  await vois.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="ثيم$"))
async def jepThe(theme):
  rl = random.randint(2,510)
  url = f"https://t.me/uwrwe/{rl}"
  await theme.client.send_file(theme.chat_id,url,caption="᯽︙ THEME BY : @uwrwe 🎊",parse_mode="html")
  await theme.delete()
@jepiq.on(admin_cmd(outgoing=True, pattern="لاتغلط$"))
async def jepmeme(memejep):
  Jep = await reply_id(memejep)
  url = f"https://t.me/uwrwe"
